...
<head>
    ...
    <title>Instagram Multimedia Report</title>
    ...
    <body class="bg-gray-100 hold-transition sidebar-mini layout-fixed">
        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div class="overflow-x-auto bg-white shadow-md">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="border border-gray-300 px-4 py-2 text-center">
                                    ...
                                    @if ($itmultimediainstagram->gambar)
                                        <img src="{{ asset('images/it/multimediainstagram/' . $itmultimediainstagram->gambar) }}" alt="Eror Image" class=" shadow-md hover:shadow-xl rounded-md transition-shadow duration-300 h-16 mx-auto object-cover cursor-pointer" onclick="openModal('{{ asset('images/it/multimediainstagram/' . $itmultimediainstagram->gambar) }}')">
                                    @else
                ...
                <div class="m-4">
                    {{ $itmultimediainstagrams->links('pagination::tailwind') }}
                </div>
            </div>
        </div>
        </div>
