...
<head>
    ...
    <body class="bg-gray-100 hold-transition sidebar-mini layout-fixed">
        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            <h1 class="flex text-4xl font-bold text-red-600 justify-center mt-4">Business Development Report</h1>
                ...
                <table class="table-auto w-full border-collapse border border-gray-300">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="border border-gray-300 px-4 py-2 text-center">Difficulty</th>
                            <th class="border border-gray-300 px-4 py-2 text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($laporanbizdevgambars as $key => $laporanbizdevgambar)
                            <tr class="hover:bg-gray-100">
                                <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporanbizdevgambar->tanggal_formatted }}</td>
                                ...
                                <div class="bg-white w-1/2 p-6 rounded shadow-lg">
                                    ...
                                    <form method="POST" action="{{ route('laporanbizdevgambar.update', $laporanbizdevgambar->id_laporan_bizdev_gambar) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="space-y-4 max-h-[60vh] overflow-y-auto">
                                            ...
                                            <div>
                                                <label for="kendala" class="block text-sm font-medium">Difficulty</label>
                ...
                <div x-data="{ open: false }" class="flex justify-end max-w-md ml-auto p-4">
                    ...
                    <div x-show="open" x-cloak class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                        <div class="bg-white p-6 rounded-lg shadow-lg w-96 relative">
                            ...
                            <form action="{{ route('laporanbizdevgambar.exportPDF') }}" method="POST">
                                @csrf
