...
<body class="bg-gray-100 p-6">
    ...
    <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow">
        <!-- Page Header -->
        <h1 class="text-3xl font-bold mb-5">Laba Rugi</h1>
                ...
                <tbody>
                    @foreach ($laporanlabarugis as $laporanlabarugi)
                        <tr class="hover:bg-gray-100">
                            <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporanlabarugi->bulan_formatted }}</td>
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                @if ($laporanlabarugi->gambar)
                                    <img src="{{ asset('images/accounting/labarugi/' . $laporanlabarugi->gambar) }}" alt="Eror Image" class="h-16 mx-auto">
                                @else
                            ...
                            <td class="border border-gray-300 px-4 py-2">{{ $laporanlabarugi->keterangan }}</td>
                            <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                <!-- Edit Button -->
                                <button class="bg-yellow-500 text-white px-3 py-2 rounded hover:bg-yellow-600" data-modal-target="#editEventModal{{ $laporanlabarugi->id_labarugi }}">
                                    <i class="fa fa-pen"></i>
                                    Edit
                                </button>
                                <!-- Delete Form -->
