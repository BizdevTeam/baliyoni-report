...
<head>
    ...
    <title>Cash, Debts, Receivables, and Stock</title>
        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300" id="data-table">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 text-center">Cash</th>
                                    <th class="border border-gray-300 px-4 py-2 text-center">Debts</th>
                                    <th class="border border-gray-300 px-4 py-2 text-center">Receivables</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    <td class="border border-gray-300 px-4 py-2 text-center">{{ $kashutangpiutangstok->tanggal_formatted }}</td>
                                    ...
                                    <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                        <!-- Edit Button -->
                                        <button class="text-red-600 bg-transparent px-3 py-2 rounded" data-modal-target="#editEventModal{{ $kashutangpiutangstok->id_khps }}">
                                            <i class="fa fa-pen"></i>
                                        </button>
                                        ...
                                        <form method="POST" action="{{ route('khps.update', $kashutangpiutangstok->id_khps) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="space-y-4">
                                                <div>
                                                    ...
                                                    <input type="date" name="tanggal" class="w-full p-2 border rounded" value="{{ $kashutangpiutangstok->tanggal }}" required>
                                                </div>
                                                <div>
                                                    <label for="kas" class="block text-sm font-medium">Cash</label>
                                                ...
                                                <div>
                                                    <label for="piutang" class="block text-sm font-medium">Receivables</label>
                    ...
                    <div class="m-4">
                        {{ $kashutangpiutangstoks->withQueryString()->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
            <div id="formChart" class="visible">
                <div class="flex flex-col mx-auto bg-white p-6 mt-4 rounded-lg shadow-xl border border-grey-500">
                    <h1 class="text-4xl font-bold text-red-600 mb-4 font-montserrat text-start mx-auto">Cash Debts Receivables Stock Chart</h1>
...
<script>
    ...
    const tableContent = items
        .filter(item => item.tanggal && item.kas && item.hutang && item.piutang && item.stok)
        .map(item => `
            <tr>
