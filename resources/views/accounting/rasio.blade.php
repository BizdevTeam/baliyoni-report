                    ...
                    <table class="table-auto w-full border-collapse text-gray-700 text-sm">
                        <thead class="bg-gradient-to-r from-gray-200 to-gray-300 text-gray-900 font-semibold">
                            <tr class="font-sans">
                                ...
                                <th class="px-6 py-3 text-center border-b " data-aos="fade-right" data-aos-duration="400" data-aos-easing="ease-out-sine">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($laporanrasios as $laporanrasio)
                            <tr class="even:bg-gray-50 odd:bg-white hover:bg-gray-100 transition duration-300">
                                <td class="px-6 py-4 text-center text-pretty border-b" data-aos="fade-right" data-aos-duration="400" data-aos-easing="ease-out-sine">{{ $laporanrasio->tanggal_formatted }}</td>
                                ...
                                <td class="px-6 py-4 text-center text-pretty border-b" data-aos="fade-right" data-aos-duration="400" data-aos-easing="ease-out-sine">
                                ...
                                <td class="px-6 py-4 text-center text-pretty border-b" data-aos="fade-right" data-aos-duration="400" data-aos-easing="ease-out-sine">{{ $laporanrasio->keterangan }}</td>
                            ...
                            <div class="fixed z-50 overflow-y-auto inset-0 backdrop-blur-sm bg-black bg-opacity-70 w-full flex items-center justify-center hidden" id="editEventModal{{ $laporanrasio->id_rasio }}">
                                    ...
                                    <form method="POST" action="{{ route('rasio.update', $laporanrasio->id_rasio) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2">
                                                    <img src="images/accounting/rasio/{{ $laporanrasio->gambar }}" alt="Event Image" class="h-16">
                                                              </div>
                                            </div>
                                            <div>
                                                ...
                                                <div class="mt-2">
                                                    <a href="{{ asset('files/accounting/rasio/' . $laporanrasio->file_excel) }}" class="text-blue-600 underline hover:text-blue-800">
                                                        Unduh File Excel
                                                    </a>
                                                </div>
                                            </div>
