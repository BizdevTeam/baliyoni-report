...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-5">
        <!-- Page Header -->
        <h1 class="text-3xl font-bold mb-5">Laporan PPN</h1>
                    ...
                    @foreach ($laporanppns as $laporanppn)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                <!-- Edit Button -->
                                <button class="bg-yellow-500 text-white px-3 py-2 rounded hover:bg-yellow-600" data-modal-target="#editEventModal{{ $laporanppn->id_laporanppn }}">
                                    <i class="fa fa-pen"></i>
                                    Edit
                                </button>
                                <!-- Delete Form -->
