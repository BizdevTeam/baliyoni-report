                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                ...
                                <tr class="even:bg-gray-50 odd:bg-white hover:bg-gray-100 transition duration-300">
                                    ...
                                    <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporantaxplaning->keterangan }}</td>
                                ...
                                <div class="fixed z-50 overflow-y-auto inset-0 backdrop-blur-sm bg-black bg-opacity-70 w-full flex items-center justify-center hidden" id="editEventModal{{ $laporantaxplaning->id_taxplaning }}">
                                        ...
                                        <form method="POST" action="{{ route('taxplaning.update', $laporantaxplaning->id_taxplaning) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-2">
                                                        <img src="{{ asset('images/accounting/taxplaning/' . $laporantaxplaning->gambar) }}" alt="Event Image" class="h-16">
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div class="mt-2">
                                                        <a href="{{ asset('files/accounting/taxplaning/' . $laporantaxplaning->file_excel) }}" class="text-blue-600 underline hover:text-blue-800">
                                                            Unduh File Excel
                                                        </a>
                                                    </div>
                                                </div>
