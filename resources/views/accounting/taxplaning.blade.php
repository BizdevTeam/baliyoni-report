    ...
    <div class="wrapper">
        ...
        <div id="admincontent" class="content-wrapper ml-64 p-4 bg-gray-100 duration-300">
            <div class="mx-auto bg-white p-6 rounded-lg shadow">
                <h1 class="text-2xl font-bold text-red-600 mb-2 font-montserrat">Laporan Tax Planing</h1>

        <!-- Action Buttons -->
        <div class="flex items-center mb-4">
            <form method="GET" action="{{ route('taxplaning.index') }}">
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                @if ($laporantaxplaning->gambar)
                                    <img src="{{ asset('images/accounting/taxplaning/' . $laporantaxplaning->gambar) }}" alt="Eror Image" class="h-16 mx-auto">
                                @else
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                @if ($laporantaxplaning->file_excel)
                                    <a href="{{ asset('files/accounting/taxplaning/' . $laporantaxplaning->file_excel) }}" 
                                ...
                                <form method="POST" action="{{ route('taxplaning.update', $laporantaxplaning->id_taxplaning) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <img src="{{ asset('images/accounting/labarugi/' . $laporantaxplaning->gambar) }}" alt="Event Image" class="h-16">
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                    <a href="{{ asset('files/accounting/labarugi/' . $laporantaxplaning->file_excel) }}" 
                                                       class="text-blue-600 underline hover:text-blue-800">
                                                        Unduh File Excel
                                                    </a>
                                            </div>
