...
<head>
    ...
    <title>ASP Service Revenue Recap</title>
...
<body class="bg-gray-100 hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            <h1 class="flex text-4xl font-bold text-red-600 justify-center mt-4">ASP Service Revenue Recap</h1>
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300" id="data-table">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 text-center">Revenue Value</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    <td class="border border-gray-300 px-4 py-2 text-center">{{ $rekappendapatanservisasp->tanggal_formatted }}</td>
                                    ...
                                    <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                        <!-- Edit Button -->
                                        <button class="text-red-600 bg-transparent px-3 py-2 rounded" data-modal-target="#editEventModal{{ $rekappendapatanservisasp->id_rpsasp }}">
                                            <i class="fa fa-pen"></i>
                                        </button>
                                        <!-- Delete Form -->
                                        ...
                                        <form method="POST" action="{{ route('rekappendapatanservisasp.update', $rekappendapatanservisasp->id_rpsasp) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="space-y-4">
                                                <div>
                                                    ...
                                                    <input type="date" name="tanggal" class="w-full p-2 border rounded" value="{{ $rekappendapatanservisasp->tanggal }}" required>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    <label for="nilai_pendapatan" class="block text-sm font-medium">Revenue Value</label>
