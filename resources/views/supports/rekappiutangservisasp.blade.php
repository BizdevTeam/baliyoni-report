        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="m-4">
                        {{ $rekappiutangservisasps->withQueryString()->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
            <div id="formChart" class="visible">
                <div class="flex flex-col mx-auto bg-white p-6 mt-4 rounded-lg shadow-xl border border-grey-500">
                    ...
                    <div class="mt-6 flex justify-end">
                        <button onclick="exportToPDF()" class="bg-red-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderChartFromTable() {
                ...
                const chartData = {
                    labels: labels,
                    datasets: [{
                        label: 'ASP Service Revenue Value',
                        data: data,
