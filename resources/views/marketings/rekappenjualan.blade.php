                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    <td class="border border-gray-300 px-4 py-2 text-center">{{
                                        $rekappenjualan->bulan_formatted }}</td>
                                    <td class="border border-gray-300 px-4 py-2 text-center">{{
                                ...
                                <div class="fixed z-50 inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden"
                                    id="editEventModal{{ $rekappenjualan->id_rp }}">
                                    <div class="bg-white w-1/2 p-6 rounded shadow-lg">
                                        <h3 class="text-xl font-semibold mb-4">Edit Data</h3>
                                        <form method="POST"
                                            action="{{ route('rekappenjualan.update', $rekappenjualan->id_rp) }}"
                                            ...
                                            <div class="space-y-4">
                                                <div>
                                                    ...
                                                    <input type="month" name="bulan" class="w-full p-2 border rounded"
                                                        value="{{ $rekappenjualan->bulan }}" required>
                                                </div>
                                                <div>
