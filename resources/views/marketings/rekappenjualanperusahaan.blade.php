        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                        <button class="text-red-600 bg-transparent px-3 py-2 rounded" data-modal-target="#editEventModal{{ $rekappenjualanperusahaan->id }}"><i class="fa fa-pen"></i></button>
                                        <form method="POST" action="{{ route('rekappenjualanperusahaan.destroy', $rekappenjualanperusahaan->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button class="text-red-600 bg-transparent px-3 py-2 rounded" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <div class="m-4">
                        {{ $rekappenjualanperusahaans->withQueryString()->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
            ...
            <div id="formChart" class="visible">
                <div class="flex flex-col mx-auto bg-white p-6 mt-4 rounded-lg shadow-xl border border-grey-500 chart-group">
                    <div class="mb-4 flex justify-between items-center">
                        <h1 class="text-2xl font-bold text-red-600 font-montserrat mx-auto">Sales Recap by Company Chart</h1>
