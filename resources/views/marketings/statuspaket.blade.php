            ...
            <div class="flex items-center justify-end transition-all duration-500 mt-8 mb-4">
                ...
                <form method="GET" action="{{ route('statuspaket.index') }}" class="flex items-center gap-2">
                    <div class="flex items-center border border-gray-700 rounded-lg p-2 max-w-md">
                        <input type="month" name="search" placeholder="Cari berdasarkan BB / TTTT" value="{{ request('search') }}" class="flex-1 border-none focus:outline-none text-gray-700 placeholder-gray-400" />
                    </div>
