        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                        <button class="bg-transparent text-red-600 px-3 py-2 rounded" data-modal-target="#editEventModal{{ $laporansakitdivisi->id_laporan_sakit_divisi }}"><i class="fa fa-pen"></i></button>
                                        <form method="POST" action="{{ route('laporansakitdivisi.destroy', $laporansakitdivisi->id_laporan_sakit_divisi) }}">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="m-4">
                        {{ $laporansakitdivisis->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
            ...
            <div id="formChart" class="visible">
                <div class="flex flex-col mx-auto bg-white p-6 mt-4 rounded-lg shadow-xl border border-grey-500">
                    <h1 class="text-2xl font-bold text-red-600 mb-4 font-montserrat text-center">Sick Leave Report Chart</h1>
        ...
        async function exportToPDF() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    a.href = url;
                    a.download = 'laporansakitdivisi.pdf';
