                ...
                <tbody>
                    @foreach ($laporansakits as $laporansakit)
                        <tr class="hover:bg-gray-100">
                            <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporansakit->bulan_formatted }}</td>
                                ...
                                <form method="POST" action="{{ route('laporansakit.update', $laporansakit->id_sakit) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="month" name="bulan" class="w-full p-2 border rounded" value="{{ $laporansakit->bulan }}" required>
                                        </div>
                                        <div>
...
<script>
    ...
    const tableContent = items
        .filter(item => item.bulan && item.nama && item.total_sakit)
        .map(item => `
            <tr>
