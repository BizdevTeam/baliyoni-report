    ...
    <div class="wrapper">
        ...
        <div id="admincontent" class="content-wrapper ml-64 p-4 bg-gray-100 duration-300">
            <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow">
                <h1 class="text-2xl font-bold mb-4">Lapiran HRD (Cuti)</h1>
                    <!-- Button Tambah Data -->
        ...
        <div id="modal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
            <div class="bg-white p-6 rounded shadow w-full max-w-md">
                ...
                <form id="modal-form" class="space-y-4">
                    ...
                    <div>
                        <label for="modal-total_cuti" class="block text-sm font-medium">Total Cuti</label>
                        <input type="text" id="modal-total_cuti" name="total_cuti"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            modalForm.addEventListener('submit', async (e) => {
                ...
                const totalCuti = Number(document.getElementById('modal-total_cuti').value);
                const nama = document.getElementById('modal-nama').value.trim();

                if (!bulanTahun || isNaN(totalCuti) || totalCuti < 0) {
            ...
            window.editData = function(id, data) {
                ...
                document.getElementById('modal-total_cuti').value = parsedData.total_cuti;
