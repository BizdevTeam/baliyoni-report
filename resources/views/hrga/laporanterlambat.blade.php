            ...
            <table class="table-auto w-full border-collapse border border-gray-300" id="data-table">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="border border-gray-300 px-4 py-2 text-center">Late Arrival Total</th>
                ...
                <tbody>
                    @foreach ($laporanterlambats as $laporanterlambat)
                        <tr class="hover:bg-gray-100">
                            <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporanterlambat->tanggal_formatted }}</td>
                                ...
                                <form method="POST" action="{{ route('laporanterlambat.update', $laporanterlambat->id_terlambat) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="date" name="tanggal" class="w-full p-2 border rounded" value="{{ $laporanterlambat->tanggal }}" required>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label for="total_terlambat" class="block text-sm font-medium">Late Arrival Total</label>
...
<script>
    ...
    const tableContent = items
        .filter(item => item.tanggal && item.nama && item.total_terlambat)
        .map(item => `
            <tr>
