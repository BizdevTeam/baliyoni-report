        ...
        <div class="wrapper">
            ...
            <div id="admincontent" class="content-wrapper ml-64 p-4 bg-gray-100 duration-300">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                    <h1 class="text-2xl font-bold text-red-600 mb-2 font-montserrat">Laporan iJASA Gambar</h1>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="border border-gray-300 px-4 py-2 text-center">
                                    @if ($ijasagambar->gambar)
                                        <img src="{{ asset('images/hrga/ijasagambar/' . $ijasagambar->gambar) }}" alt="Eror Image" class="h-16 mx-auto">
                                    @else
                                        <img src="{{ asset('images/no_image.png') }}" alt="Default Image" class="h-16 mx-auto">
                                    @endif
                                </td>
                                <td class="border border-gray-300 px-4 py-2">{{ $ijasagambar->keterangan }}</td>
                                <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                    <!-- Edit Button -->
                                    <button class="bg-red-600 text-white px-3 py-2 rounded" data-modal-target="#editEventModal{{ $ijasagambar->id_ijasa_gambar }}">
                                        <i class="fa fa-pen"></i>
                                        Edit
                                    </button>
                                    <!-- Delete Form -->
