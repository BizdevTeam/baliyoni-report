...
<body class="bg-gray-100 hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="flex items-center mb-4 gap-2">
            <form method="GET" action="{{ route('laporanizin.index') }}" class="flex items-center gap-2">
                            ...
                            <div class="bg-white w-1/2 p-6 rounded shadow-lg">
                                ...
                                <form method="POST" action="{{ route('laporanizin.update', $laporanizin->id_izin) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <label for="total_izin" class="block text-sm font-medium">Total Penjualan</label>
...
var barChart = new Chart(ctx, {
    ...
    const tableContent = items
        .filter(item => item.bulan && item.nama && item.total_izin)
        .map(item => `
            <tr>
    ...
    try {
        const response = await fetch('/hrga/laporanizin/export-pdf', {
            method: 'POST',
            headers: {
