            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border border-gray-300 py-2 text-center flex justify-center gap-2">
                                        <button class="bg-transparent text-blue-600 px-3 py-2 rounded" data-modal-target="#editEventModal{{ $laporancutidivisi->id_laporan_cuti_divisi }}"><i class="fa fa-pen"></i></button>
                                        <form method="POST" action="{{ route('laporancutidivisi.destroy', $laporancutidivisi->id_laporan_cuti_divisi) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <div>
                            {{ $laporancutidivisis->withQueryString()->links('pagination::tailwind') }}
                        </div>
                    </div>
                </div>
            </div>
