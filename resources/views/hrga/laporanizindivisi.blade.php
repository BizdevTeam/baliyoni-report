                            ...
                            <table class="table-auto w-full border-collapse border border-gray-300" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="border border-gray-300 px-4 py-2 text-center">{{ $laporanizindivisi->nama }}</td>
                        ...
                        <form method="POST" action="{{ route('laporanizindivisi.update', $laporanizindivisi->id_laporan_izin_divisi) }}" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama" class="w-full p-2 border rounded" value="{{ $laporanizindivisi->nama }}" required>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="total_izin" class="block text-sm font-medium">Sick Leave Total</label>
