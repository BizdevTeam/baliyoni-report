        ...
        <div id="admincontent" class="mt-14 content-wrapper ml-64 p-4 bg-white duration-300">
            ...
            <div id="formContainer" class="hidden">
                <div class="mx-auto bg-white p-6 rounded-lg shadow">
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300" id="data-table">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 text-center">Sick Leave Total</th>
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border border-gray-300 py-6 text-center flex justify-center gap-2">
                                        <button class="bg-transparent text-red-600 px-3 py-2 rounded" data-modal-target="#editEventModal{{ $laporanterlambatdivisi->id_laporan_terlambat_divisi }}"><i class="fa fa-pen"></i></button>
                                        <form method="POST" action="{{ route('laporanterlambatdivisi.destroy', $laporanterlambatdivisi->id_laporan_terlambat_divisi) }}">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="m-4">
                        {{ $laporanterlambatdivisis->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
            ...
            <div id="formChart" class="visible">
                <div class="flex flex-col mx-auto bg-white p-6 mt-4 rounded-lg shadow-xl border border-grey-500">
                    <h1 class="text-2xl font-bold text-red-600 mb-4 font-montserrat text-center">Late Arrival Report Chart</h1>
        ...
        async function exportToPDF() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    a.href = url;
                    a.download = 'laporanterlambatdivisi.pdf';
