...
class LaporanNegosiasiController extends Controller
{
    ...
    {
        return view('procurements.laporannegosiasi');
    }
    ...
    public function filterByYear(Request $request)
{
    ...
    $data = LaporanNegosiasi::whereYear('bulan_tahun', $tahun)->get();
    ...
    public function filterData(Request $request)
    {
        try {
            ...
            $data = LaporanNegosiasi::whereRaw("RIGHT(bulan_tahun, 4) = ?", [$tahun])->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $existingData = LaporanNegosiasi::where('bulan_tahun', $validatedData['bulan_tahun'])->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $paket = LaporanNegosiasi::findOrFail($id);

            // Prevent duplicate month-year for other records
            $existingData = LaporanNegosiasi::where('bulan_tahun', $validatedData['bulan_tahun'])
                ->where('id', '!=', $id)
                ->first();
