...
class LaporanDetransController extends Controller
{
    ...
    {
        return view('supports.laporandetrans');
    }
    ...
    public function filterByYear(Request $request)
{
    ...
    $data = LaporanDetrans::whereYear('bulan_tahun', $tahun)->get();
    ...
    public function filterData(Request $request)
    {
        try {
            ...
            $data = LaporanDetrans::whereRaw("RIGHT(bulan_tahun, 4) = ?", [$tahun])->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $existingData = LaporanDetrans::where('bulan_tahun', $validatedData['bulan_tahun'])->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $paket = LaporanDetrans::findOrFail($id);

            // Prevent duplicate month-year for other records
            $existingData = LaporanDetrans::where('bulan_tahun', $validatedData['bulan_tahun'])
                ->where('id', '!=', $id)
                ->first();
