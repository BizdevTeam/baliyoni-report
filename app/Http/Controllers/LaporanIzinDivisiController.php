...
public function index(Request $request)
    {
        ...
        //     $aiInsight = $this->generateSickLeaveInsight($laporanizindivisis, $chartData);
        // }
                    ...
                    <table style='border-collapse: collapse; width: 100%; font-size: 10px;' border='1'>
                        <thead>
                            <tr style='background-color: #f2f2f2;'>
                                ...
                                <th style='border: 1px solid #000; padding: 1px;'>Employee</th>
                                <th style='border: 1px solid #000; padding: 2px;'>Division</th>
