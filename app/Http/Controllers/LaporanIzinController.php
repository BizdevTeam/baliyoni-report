...
class LaporanIzinController extends Controller
{
    ...
    public function exportPDF(Request $request)
    {
        try {
            ...
            $mpdf->SetFooter('{DATE j-m-Y}|Laporan Laporan Izin|Halaman {PAGENO}');
    
            // Buat konten tabel dengan gaya CSS yang lebih ketat
            $tableHTMLContent = "
                <h1 style='text-align:center; font-size: 16px; margin-top: 50px;'>Laporan Izin</h1>
                ...
                <table style='border-collapse: collapse; width: 100%; font-size: 10px;' border='1'>
                    <thead>
                        <tr style='background-color: #f2f2f2;'>
                            ...
                            <th style='border: 1px solid #000; padding: 5px;'>Total Izin</th>
                        </tr>
                    </thead>
                    <tbody>
                        {$tableHTML}
            ...
            if (!empty($chartBase64)) {
                $chartHTMLContent = "
                    <h1 style='text-align:center; font-size: 16px; margin: 10px 0;'>Grafik Laporan Izin</h1>
