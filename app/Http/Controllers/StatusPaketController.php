...
class StatusPaketController extends Controller
{
    ...
    public function exportPDF(Request $request)
    {
        try {
            ...
            $mpdf->SetFooter('{DATE j-m-Y}|Laporan Status Paket|Halaman {PAGENO}');
    
            // Buat konten tabel dengan gaya CSS yang lebih ketat
            $tableHTMLContent = "
                <h1 style='text-align:center; font-size: 16px; margin-top: 50px;'>Laporan Status Paket</h1>
            ...
            if (!empty($chartBase64)) {
                $chartHTMLContent = "
                    <h1 style='text-align:center; font-size: 16px; margin: 10px 0;'>Grafik Laporan Status Paket</h1>
