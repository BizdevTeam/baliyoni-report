...
class LaporanSamitraController extends Controller
{
    ...
    {
        return view('supports.laporansamitra');
    }
    ...
    public function filterByYear(Request $request)
    {
        ...
        $data = laporansamitra::whereYear('bulan_tahun', $tahun)->get();
        ...
        public function filterData(Request $request)
        {
            try {
                ...
                $data = laporansamitra::whereRaw("RIGHT(bulan_tahun, 4) = ?", [$tahun])->get();
        ...
        public function data(Request $request)
        {
            try {
                ...
                $totalPaket = $pakets->sum('total_pengiriman'); // Pakai tanda kutip tunggal (')
        ...
        public function store(Request $request)
        {
            ...
            try {
                ...
                $existingData = laporansamitra::where('bulan_tahun', $validatedData['bulan_tahun'])->first();
                ...
                laporansamitra::create($validatedData);
        ...
        public function update(Request $request, $id)
        {
            ...
            try {
                $paket = laporansamitra::findOrFail($id);
    
                // Prevent duplicate month-year for other records
                $existingData = laporansamitra::where('bulan_tahun', $validatedData['bulan_tahun'])
                    ->where('id', '!=', $id)
                    ->first();
