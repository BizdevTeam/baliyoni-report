...
class LaporanTerlambatController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'total_terlambat' => 'required|array|min:1',
        ...
        try {
            ...
            LaporanTerlambat::insert($dataToInsert);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            LaporanTerlambat::where('id', $id)->delete();
    ...
    {
        try {
            $paket = LaporanTerlambat::findOrFail($id);
            $paket->delete();
    ...
    private function prepareDataForInsert($validated)
    {
        ...
        foreach ($validated['nama'] as $index => $nama) {
            $dataToInsert[] = [
                ...
                'nama' => $nama,
                'total_terlambat' => $validated['total_terlambat'][$index],
                'created_at' => now(),
                'updated_at' => now(),
            ];
        }
