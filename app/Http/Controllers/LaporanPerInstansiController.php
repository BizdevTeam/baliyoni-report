...
class LaporanPerInstansiController extends Controller
{
    ...
    public function exportPDF(Request $request)
    {
        try {
            ...
            $mpdf->SetFooter('{DATE j-m-Y}|Laporan Penjualan Perinstansi|Halaman {PAGENO}');
    
            // Buat konten tabel dengan gaya CSS yang lebih ketat
            $tableHTMLContent = "
                <h1 style='text-align:center; font-size: 16px; margin-top: 50px;'>Laporan Penjualan Perinstansi</h1>
            ...
            if (!empty($chartBase64)) {
                $chartHTMLContent = "
                    <h1 style='text-align:center; font-size: 16px; margin: 10px 0;'>Grafik Laporan Penjualan Perinstansi</h1>
